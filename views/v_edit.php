...
<body>
  ...
  <div class="h2"> <h2>Input Tamu</h2></div>
    ...
    <form method="post" action="edit.php">
        ...
        <input type="hidden" name="id" value="<?= $tamu_dishub['id'] ?>">
            <label for="nama">NAMA LENGKAP</label>
            <input type="text" name="nama" id="nama" value="<?= @$tamu_dishub['nama'] ?>" placeholder="Tulis No HP atau WhatsApp Aktif...">
        </div>

        <div class="form-group">
            <label>JENIS KELAMIN</label>
            <input type="radio" name="jenis_kelamin" value="Laki-laki" <?= @$tamu_dishub['jenis_kelamin'] == 'Laki-laki' ? 'selected' : '' ?>> Laki-laki
            <input type="radio" name="jenis_kelamin" value="Perempuan" <?= @$tamu_dishub['jenis_kelamin'] == 'Perempuan' ? 'selected' : '' ?>> Perempuan
        ...
        <div class="form-group">
            ...
            <br> 
            <input type="radio" name="jenis_tamu" value="Perorangan/Masyarakat Umum" <?= @$tamu_dishub['Perorangan/Masyarakat Umum'] == 'Perorangan/Masyarakat Umum' ? 'selected' : '' ?>> Perorangan/Masyarakat Umum
            <br>
            <input type="radio" name="jenis_tamu" value="Lembaga/Instansi" <?= @$tamu_dishub['Lembaga/Instansi'] == 'Lembaga/Instansi' ? 'selected' : '' ?>> Lembaga/Instansi
        </div>
        ...
        <div class="form-group">
            ...
            <input name="keterangan" id="keterangan" value="<?= @$tamu_dishub['keterangan'] ?>" placeholder="Tulis keterangan keperluan Anda..."></input>
        </div>
